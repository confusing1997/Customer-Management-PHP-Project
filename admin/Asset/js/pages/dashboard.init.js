    ...
    e.prototype.respChart=function(e,r,a,t){
        ...
        switch(r){
            ...
            data:
                ...
                datasets:[{label:"Resources Analytics",backgroundColor:"#3ec396",borderColor:"#3ec396",borderWidth:1,hoverBackgroundColor:"#3ec396",hoverBorderColor:"#3ec396",
                
                data:[sh1_staff,sh2_staff,sh3_staff]}]},
                
                {scales:{yAxes:[{gridLines:{color:"rgba(255,255,255,0.05)",fontColor:"#fff"},
                
                ticks:{max:20,min:0,stepSize:5}}],xAxes:[{gridLines:{color:"rgba(0,0,0,0.1)"}}]}})},
